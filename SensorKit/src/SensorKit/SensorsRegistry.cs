...
namespace SensorKitSDK
{
    public class SensorsRegistry
    {
        List<SensorInformation> _registry = new List<SensorInformation>()
        {
            ...
            //new SensorInformation{ Model=SensorTypes.SK, Manufacturer="SensorKit", Url = "https://zmove.io/products/zmove", ShortDescription = "Universal sports sensor",  Capabilities = new List<SensorCapabilities> {SensorCapabilities.IMU, SensorCapabilities.AirTime, SensorCapabilities.Battery, SensorCapabilities.Ski, SensorCapabilities.TelemarkSki, SensorCapabilities.Snowboard, SensorCapabilities.Kiteboarding, SensorCapabilities.Surfing, SensorCapabilities.MountainBike, SensorCapabilities.Skateboard, SensorCapabilities.Windsurfing}, Format="SK"},
            new SensorInformation{ Model=SensorTypes.S1, Manufacturer="SensorKit", Url = "https://zmove.io/products/zmove", ShortDescription = "Universal sports sensor",  Capabilities = new List<SensorCapabilities> {SensorCapabilities.IMU, SensorCapabilities.AirTime, SensorCapabilities.Battery, SensorCapabilities.Ski, SensorCapabilities.TelemarkSki, SensorCapabilities.Snowboard, SensorCapabilities.Kiteboarding, SensorCapabilities.Surfing, SensorCapabilities.MountainBike, SensorCapabilities.Skateboard, SensorCapabilities.Windsurfing}, Format="S1"},
            //new SensorInformation{ Model=SensorTypes.S2, Manufacturer="SensorKit", Url = "https://zmove.io/products/zmove", ShortDescription = "Universal sports sensor",  Capabilities = new List<SensorCapabilities> {SensorCapabilities.IMU, SensorCapabilities.AirTime, SensorCapabilities.Battery, SensorCapabilities.Ski, SensorCapabilities.TelemarkSki, SensorCapabilities.Snowboard, SensorCapabilities.Kiteboarding, SensorCapabilities.Surfing, SensorCapabilities.MountainBike, SensorCapabilities.Skateboard, SensorCapabilities.Windsurfing}, Format="S2"},
